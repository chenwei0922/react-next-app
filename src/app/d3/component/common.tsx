...
export const ChartFrame = ({title, children, className}: {title: string; children: React.ReactNode; className?: string}) => {
  return (
    <div className={cn("relative bg-no-repeat bg-cover bg-center bg-[url(/images/line.png)]", 'border-[1px] border-[rgba(25,186,139,0.17)] p-2', className)} style={{ backgroundImage: `url(${getAssetUrl("/images/line.png")})`}}>
